<?php
  ...
  if(!$conn){
    die("Sorry we fauled to connect: ".mysqli_connect_error());
  }
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
    if(isset($_POST['snoEdit'])){
      ...
      if($result){
        ...
        echo "The record has not been updated successfully! ".mysqli_error($conn);
      }
    }else{
      $title = $_POST["title"];
...
<head>
  ...
  <title>Notes - Take your note</title>
  ...
  <?php
    if($insert){
      echo "<div class='alert alert-success alert-dismissible fade show' role='alert'>
            <strong>Success!</strong> Note has been sumitted successfully.
